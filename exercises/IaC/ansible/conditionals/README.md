...
fatal: [127.0.0.1]: FAILED! => {"changed": false, "msg": "Required variable 'installation_dir' not set"}
	to retry, use: --limit @/mnt/cic_working_dir/exercises/IaC/ansible/conditionals/ansible/when.retry
...
TASK [include] *****************************************************************
included: /mnt/cic_working_dir/exercises/IaC/ansible/conditionals/ansible/create_users_and_groups.yml for 127.0.0.1 => (item={'key': 'Admin', 'value': ['user1', 'user2']})
included: /mnt/cic_working_dir/exercises/IaC/ansible/conditionals/ansible/create_users_and_groups.yml for 127.0.0.1 => (item={'key': 'Team', 'value': ['user3', 'user4', 'user5']})
...
rootdir: /mnt/cic_working_dir/exercises/IaC/ansible/conditionals, inifile:
